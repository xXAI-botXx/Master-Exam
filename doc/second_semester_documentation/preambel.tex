...
\usepackage{tikz}
\usepackage{enumitem}  % dense listings
...
\automark{} % remove automatic marks
\ihead{}    % Kopfzeile links leeren
\chead{}    % Kopfzeile mitte leeren
\ohead{}    % Kopfzeile rechts leeren
